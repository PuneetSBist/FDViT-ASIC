...
# #################################CHANGE THIS###################################################
# TOP_LEVEL_NAME
set top_level 			"flexible_downsampling"
# PATH TO YOUR VERILOG NETLIST
set netlist_search_path "../v"
# NETLIST NAME
set netlist_name "flexible_downsampling.sv"
# CLOCK PERIOD
set clk_period 			600
# ################################################################################################
...
$netlist_search_path/flexible_downsampling.sv \
$netlist_search_path/downsample.sv \
$netlist_search_path/bilinear_interpolation.sv \
$netlist_search_path/tb_flexible_downsampling.sv"
...
# CUSTOM LINE
#set_register_replication -max_fanout 16 [all_registers]
...
write_file -hierarchy -format verilog -output "./${out_path}/${top_level}.${clk_period}.syn.v"
# Save current design
write_file -hierarchy -format ddc -output "./${out_path}/${top_level}.ddc"

# Generate Standard Delay Format (SDF) file
write_sdf -context verilog "./${out_path}/${top_level}.${clk_period}.syn.sdf"

# Generate timing constraints file
write_sdc "./${out_path}/${top_level}.${clk_period}.syn.sdc"

# Generate report file
set maxpaths 100
#set minpaths 100
set rpt_file "../rpt/${top_level}.${clk_period}.syn"
